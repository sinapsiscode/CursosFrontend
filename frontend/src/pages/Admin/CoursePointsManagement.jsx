...
const CoursePointsManagement = () => {
  ...
  const handleSavePoints = async (courseId) => {
    ...
    // Actualizar el curso con los nuevos puntos
    ...
    if (updatedCourse) {
      ...
      // Si tienes una función updateCourse en el store, úsala
          ...
          <table className="w-full">
            ...
            <tbody>
              {filteredCourses.map(course => (
                <tr key={course.id} className="border-b border-gray-700/50 hover:bg-gray-800/50">
                  ...
                  <td className="py-4 px-6 text-center">
                    {editingCourse === course.id ? (
                      <input
                        ...
                        className="w-24 px-2 py-1 bg-gray-700 text-white rounded border border-gray-600 focus:border-accent focus:outline-none text-center"
                        min="0"
                        step="10"
                        autoFocus
                      />
