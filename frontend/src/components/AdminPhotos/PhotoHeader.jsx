/**
 * PhotoHeader component - Header with title and action buttons
 */
const PhotoHeader = ({ onConfigAdvertising, onConfigLinks, onConfigButtons, onAddPhoto }) => {
  return (
