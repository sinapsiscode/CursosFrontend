...
// Removido import circular - whatsappService se importa donde se necesita
  ...
  handleAction(notificationId, actionIndex) {
    ...
    if (action.url) {
      if (action.url.startsWith('https://wa.me/') || action.url.startsWith('https://chat.whatsapp.com/')) {
        // WhatsApp link - abrir directamente por ahora
        // TODO: Resolver dependencia circular con whatsappService
