...
const CourseNotifications = ({ course }) => {
  ...
  useEffect(() => {
    ...
    }, hardcodedValues?.timers?.notificationInterval || 30000)
    ...
    if (course.nextWebinar) {
      ...
      }, hardcodedValues?.timers?.courseNotificationDelay || 45000)
  ...
  const handleLessonComplete = (lesson) => {
    ...
    if (lesson.progress >= 50) {
      ...
      }, hardcodedValues?.timers?.whatsappResponseDelay || 3000)
    }
