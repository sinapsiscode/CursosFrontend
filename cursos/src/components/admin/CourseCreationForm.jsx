...
const CourseCreationForm = ({ onClose, onSave, editingCourse = null, activeAreas = [], levels = [] }) => {
  ...
  // Estado para valores hardcodeados
      ...
      try {
        ...
        setHardcodedValues({
          placeholders: {
            ...
            courseTitle: 'Ej: Fundamentos de Metalurgia',
            instructorName: 'Dr. Juan Pérez',
            courseDescription: 'Describe lo que los estudiantes aprenderán en este curso...'
          },
          examples: {
            courseEnrollmentUrl: 'https://ejemplo.com/inscribirse-curso'
          }
        })
      }
    }
        ...
        setUploadProgress(prev => {
          ...
          if (currentProgress >= 100) {
            ...
            try {
              ...
              const fileUrl = `${config.STORAGE_URL}/${type}/${fileId}_${fileName}`
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={hardcodedValues?.placeholders?.courseTitle || 'Ej: Fundamentos de Metalurgia'}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={hardcodedValues?.placeholders?.instructorName || 'Dr. Juan Pérez'}
                  />
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={hardcodedValues?.placeholders?.courseDescription || 'Describe lo que los estudiantes aprenderán en este curso...'}
                />
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-background border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-accent"
                    placeholder={hardcodedValues?.examples?.courseEnrollmentUrl || 'https://ejemplo.com/inscribirse-curso'}
                  />
