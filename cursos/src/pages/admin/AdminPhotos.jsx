  ...
  const loadProfileLinks = () => {
    try {
      ...
      if (Object.keys(storedLinks).length > 0) {
        ...
        const defaultLinks = {
          proUpgradeUrl: hardcodedValues?.examples?.upgradeProUrl || 'https://ejemplo.com/upgrade-pro',
          whatsappChannelUrl: hardcodedValues?.examples?.whatsappChannelUrl || 'https://chat.whatsapp.com/ejemplo123'
        }
        ...
        const samplePhotos = [
          {
            ...
            imageUrl: hardcodedValues?.urls?.imageExamples?.unsplashSamples?.[0] || "https://images.unsplash.com/photo-1518929458119-e5bf444c30f4?w=800",
            date: "2024-01-15",
            active: true,
          ...
          },
          {
            ...
            imageUrl: hardcodedValues?.urls?.imageExamples?.unsplashSamples?.[1] || "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=800",
            date: "2024-02-20",
            active: true,
          ...
          },
          {
            ...
            imageUrl: hardcodedValues?.urls?.imageExamples?.unsplashSamples?.[2] || "https://images.unsplash.com/photo-1463413547347-bd0c8dd6e25b?w=800",
            date: "2024-03-10",
            active: true,
          ...
          },
          {
            ...
            imageUrl: hardcodedValues?.urls?.imageExamples?.unsplashSamples?.[3] || "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800",
            date: "2024-04-15",
            active: true,
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            ...
            className="bg-yellow-500 text-gray-900 px-6 py-3 rounded-lg font-medium hover:bg-yellow-400 transition-colors flex items-center space-x-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-800 rounded-xl p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-gray-400 text-sm">Total de Fotos</p>
        ...
        <div className="bg-gray-800 rounded-xl p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-gray-400 text-sm">Fotos Activas</p>
        ...
        <div className="bg-gray-800 rounded-xl p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-gray-400 text-sm">Fotos Inactivas</p>
              <p className="text-2xl font-bold text-white">
                {profilePhotos.filter(photo => photo.active === false).length}
              </p>
            </div>
          ...
          <div className="bg-gray-800 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 bg-yellow-500 hover:bg-yellow-400 text-gray-900 py-2 px-4 rounded-lg font-medium transition-colors"
                >
            ...
            <form onSubmit={handleSaveLinks} className="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-yellow-500"
                  placeholder={hardcodedValues?.examples?.upgradeProUrl || "https://ejemplo.com/upgrade-pro"}
                />
