...
const RewardsManagement = () => {
  ...
  const loadRewards = () => {
    ...
    try {
      ...
      if (storedRewards) {
        ...
        const defaultRewards = loyaltyService.config?.rewards || []
        setRewards(defaultRewards)
        localStorage.setItem('loyalty_rewards', JSON.stringify(defaultRewards))
      }
    } catch (error) {
  ...
  const handleAddReward = () => {
    ...
    try {
      ...
      Swal.fire({
        title: 'Error',
        text: 'No se pudo crear la recompensa',
        icon: 'error',
        background: '#1f2937',
        color: '#f3f4f6'
      })
  ...
  const totalPointsRequired = rewards.reduce((sum, r) => sum + (r.points || 0), 0)
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-gray-800 rounded-lg p-4 text-center">
          ...
          <div className="text-gray-400 text-sm">Recompensas Totales</div>
        </div>
        <div className="bg-gray-800 rounded-lg p-4 text-center">
        ...
        <div className="bg-gray-800 rounded-lg p-4 text-center">
          ...
          <div className="text-gray-400 text-sm">Canjes Totales</div>
        </div>
        <div className="bg-gray-800 rounded-lg p-4 text-center">
      ...
      {filteredRewards.length === 0 ? (
        <div className="text-center py-16 bg-gray-800 rounded-lg">
          ...
          <h3 className="text-xl font-semibold text-white mb-2">No hay recompensas</h3>
          <p className="text-gray-400 mb-6">
            Comienza agregando recompensas que los estudiantes puedan canjear
          </p>
          <button
            onClick={() => setShowAddForm(true)}
